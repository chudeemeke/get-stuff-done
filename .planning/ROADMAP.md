...
- [ ] 43-11AJ-PLAN.md -- Wave 23: Human-gated hosted envelope, formal Fable checkpoint, and truthful 11R closure
- [ ] 43-11D-PLAN.md -- Wave 24: Finalized-head hosted recertification, exact source ownership contract, and unchanged Jest parity
- [ ] 43-11W-PLAN.md -- Wave 25: Multi-process coverage orchestration and per-group feasibility evidence
- [ ] 43-11X-PLAN.md -- Wave 26: Post-coverage-foundation whole-project Fable checkpoint
- [ ] 43-11K-PLAN.md -- Wave 27: SBOM portability and toolchain preflight
- [ ] 43-11E-PLAN.md -- Wave 28: Launcher and installer four-metric closure
- [ ] 43-11T-PLAN.md -- Wave 29: Runtime-support four-metric closure
- [ ] 43-11S-PLAN.md -- Wave 30: Post-toolchain and initial-coverage whole-project Fable checkpoint
- [ ] 43-11F-PLAN.md -- Wave 31: Compose/build/finalize four-metric closure
- [ ] 43-11U-PLAN.md -- Wave 32: Provenance/semantic/SBOM/docs-tool four-metric closure
- [ ] 43-11G-PLAN.md -- Wave 33: Audit/override/debt/OSV four-metric closure
- [ ] 43-11V-PLAN.md -- Wave 34: Benchmark/perf/cousin/flake/oversight four-metric closure
- [ ] 43-11H-PLAN.md -- Wave 35: Upstream authority/preview/vetted/churn four-metric closure
- [ ] 43-11Z-PLAN.md -- Wave 36: Compatibility and upgrade-runner four-metric closure
- [ ] 43-11I-PLAN.md -- Wave 37: Hook and sync four-metric closure
- [ ] 43-11Y-PLAN.md -- Wave 38: Pre-validator whole-project Fable checkpoint
- [ ] 43-11J-PLAN.md -- Wave 39: Explicit schemas and pure Phase 43 validator core
- [ ] 43-11AA-PLAN.md -- Wave 40: Validator adapters, blocking CI, and validator self-coverage
- [ ] 43-11AB-PLAN.md -- Wave 41: Final aggregate evidence and transactional Plan 11 transition
- [ ] 43-11-PLAN.md -- Wave 42: Post-bump assurance refresh and bounded evidence summary
- [ ] 43-11Q-PLAN.md -- Wave 43: Fresh final-head hosted CI and Fable whole-product closure
- [ ] 43-12-PLAN.md -- Wave 44: Automated D-7 candidate, human confirmation, closeout gates, and Phase 44 readiness
- [ ] 43-12B-PLAN.md -- Wave 45: Whole-project Fable entry review, post-correction hosted recertification, and reverification
- [ ] 43-12C-PLAN.md -- Wave 46: Final goal-backward verification and Phase 43 closeout
...
**Success Criteria** (what must be TRUE):
  ...
  11. Hosted release readiness enforces at least 95% statements, branches, functions, and lines independently through the Phase 11D/11W authority and runs a no-publish release-plan/dry-run job that proves package and artifact planning; reported-only coverage or a publish-capable dry run cannot satisfy either gate.
  12. Before the first post-v1.2 feature changes either Phase 43 verifier, policy evaluation is fully separated from CLI and infrastructure adapters; uniform harden-runner adoption is explicitly evaluated as a Phase 44 hardening candidate rather than silently assumed.
**Plans**: TBD
