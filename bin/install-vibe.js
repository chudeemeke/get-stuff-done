...
const GSD_DEST = path.join(VIBE_HOME, 'get-stuff-done');
...
function copyCoreFiles() {
  ...
  copyDir(path.join(GSD_SRC, 'get-stuff-done/bin'), path.join(GSD_DEST, 'bin'));
  copyDir(path.join(GSD_SRC, 'get-stuff-done/templates'), path.join(GSD_DEST, 'templates'));
  copyDir(path.join(GSD_SRC, 'get-stuff-done/references'), path.join(GSD_DEST, 'references'));
...
function patchWorkflows() {
  ...
  const workflowsSrc = path.join(GSD_SRC, 'get-stuff-done/workflows');
