...
LOCAL_VERSION_FILE="./.claude/get-stuff-done/VERSION"
LOCAL_MARKER_FILE="./.claude/get-stuff-done/workflows/update.md"
GLOBAL_VERSION_FILE="$HOME/.claude/get-stuff-done/VERSION"
GLOBAL_MARKER_FILE="$HOME/.claude/get-stuff-done/workflows/update.md"
...
```bash
npm view @chude/get-stuff-done version 2>/dev/null
```
...
**If LOCAL install:**
```bash
npx -y @chude/get-stuff-done@latest --local
```

**If GLOBAL install (or unknown):**
```bash
npx -y @chude/get-stuff-done@latest --global
```
