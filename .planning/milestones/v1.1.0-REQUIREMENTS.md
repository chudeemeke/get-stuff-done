# Requirements Archive: v1.1.0 Installer & Deployment Hardening
...
- ~~Codex `extractFrontmatterField` crash~~ (RESOLVED -- fork-specific, 4 oversight agents fixed 2026-04-09)
