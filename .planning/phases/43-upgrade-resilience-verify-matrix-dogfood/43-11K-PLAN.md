...
<task id="11K-01" type="auto">
  ...
  <acceptance_criteria>
    ...
    - 48/48 Jest suites and 1,223/1,223 current tests pass without test-source edits.
  ...
  <verify>
    <automated>bun test tests/generate-sbom.test.js tests/phase43-toolchain.test.js tests/production-source-contract.test.js tests/compose.test.js</automated>
...
<verification>
- `bun test tests/generate-sbom.test.js tests/phase43-toolchain.test.js tests/production-source-contract.test.js tests/compose.test.js`
