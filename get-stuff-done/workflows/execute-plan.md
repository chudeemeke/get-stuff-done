...
See ~/.claude/get-stuff-done/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Create `.planning/phases/XX-name/{phase}-USER-SETUP.md` using template from `~/.claude/get-stuff-done/templates/user-setup.md`.
...
Use ~/.claude/get-stuff-done/templates/summary.md for structure.
